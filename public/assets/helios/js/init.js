...
(function($) {
	...
	skel.init({
		reset: 'full',
		breakpoints: {
			'global':	{ range: '*', href: '/assets/helios/css/style.css', containers: 1400, grid: { gutters: 48 } },
			'wide':		{ range: '-1680', href: '/assets/helios/css/style-wide.css', containers: 1200 },
			'normal':	{ range: '-1280', href: '/assets/helios/css/style-normal.css', containers: '100%', grid: { gutters: 36 } },
			'narrow':	{ range: '-960', href: '/assets/helios/css/style-narrow.css', grid: { gutters: 32 } },
			'narrower': { range: '-840', href: '/assets/helios/css/style-narrower.css', containers: '100%!', grid: { collapse: true } },
			'mobile':	{ range: '-736', href: '/assets/helios/css/style-mobile.css', grid: { gutters: 20 }, viewport: { scalable: false } }
		},
		plugins: {
			layers: {
				config: {
