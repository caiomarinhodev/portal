...
public class AvaliacaoTest {
    ...
    public void testRecuperaAvaliacaoDeUmTemaPorUsuario() {
        Usuario usuario = new Usuario();
        Tema tema = new Tema("testeJava");
        Assert.assertNotNull(Portal.recuperaAvaliacao(usuario, tema));
    }
    ...
    public void testRecuperaAvaliacaoDeUmTemaPorUsuarioSemAvaliar() {
        ...
        Tema tema = new Tema("testeJava");
        Assert.assertNull(Portal.recuperaAvaliacao(usuario2, tema));
    }
    ...
    public void testRecuperaMediaDasAvaliacoes() {
        ...
        Assert.assertTrue(Portal.recuperaMediaDeAvaliacoes() == 1.5);
    }
    ...
    public void testRecuperaMedianaDasAvaliacoes() {
        ...
        Assert.assertTrue(Portal.recuperaMedianaDeAvaliacoes() == 1);
    }
}
